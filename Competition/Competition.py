...
async def multi_evaluate(
    ...
    json_dump_path = './record/Com_{}_{}_{}_{}-avg_deci_vector.json'.format(bias_type, test_mode, game_name, model_name_temp)
    write_to_json(record_with_lang, json_dump_path)
    json_dump_path = './record/Com_{}_{}_{}_{}-raw_responses.json'.format(bias_type, test_mode, game_name, model_name_temp)
