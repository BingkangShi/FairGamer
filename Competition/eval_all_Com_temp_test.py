...
if __name__ == '__main__':
    ...
    for i in range(len(args_list)):
        ...
        en_versus_matrix_3d = convert_to_3d_matrix(record_with_lang["english"])
        en_mean_vector = compute_mean_vector_3d(en_versus_matrix_3d)
        print(f"English - Mean vector: cooperate={en_mean_vector[0]:.3f}, raid={en_mean_vector[1]:.3f}, neutral={en_mean_vector[2]:.3f}")
    
        # Calculate MCV and percentages
        en_mcv_value = calculate_trace_mcv(en_versus_matrix_3d)
        ...
        print(f"English - Convergence percentage (Method 3): {en_percentage_log:.1f}%")
        print("-----------------")

        # Chinese data analysis
        ch_versus_matrix_3d = convert_to_3d_matrix(record_with_lang["chinese"])
        ch_mean_vector = compute_mean_vector_3d(ch_versus_matrix_3d)
        print(f"Chinese - Mean vector: cooperate={ch_mean_vector[0]:.3f}, raid={ch_mean_vector[1]:.3f}, neutral={ch_mean_vector[2]:.3f}")
    
        # Calculate MCV and percentages
        ch_mcv_value = calculate_trace_mcv(ch_versus_matrix_3d)
        ...
        print(f"Chinese - Convergence percentage (Method 3): {ch_percentage_log:.1f}%")
    ...
    json_dump_path = './record/temp_{}_Com_{}_analysis.json'.format(args_list[0].temperature, model_name)
