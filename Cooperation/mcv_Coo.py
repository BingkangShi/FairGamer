...
if __name__ == '__main__':
    print("========= Evaluation Results of Task Coo =========")
    ...
    for i, model_id in enumerate(model_list):
        ...
        analysis_list = read_json('./record/Coo_{}_analysis.json'.format(model_id))
    ...
    for bias_type in bias_types:
        ...
        for test_mode in test_modes:
            ...
            print(f"\nSimMCV in Coo-{mode_display} ({bias_type.capitalize()} - En):")
            print("------------------------------------------------------------------------------")
            ...
            print(f"\nSimMCV in Coo-{mode_display} ({bias_type.capitalize()} - Zh):")
            print("------------------------------------------------------------------------------")
            print("| Model Name | MCV Value | SimMCV |")
            for i, model_id in enumerate(model_list):
                avg_data = model_avg_results[model_id][bias_type][test_mode]
    ...
    print(f"\nSimMCV in Coo (English - All Bias Types):")
    print("----------------------------------------------------------------------------------------")
    ...
    print(f"\nSimMCV in Coo (Chinese - All Bias Types):")
    print("----------------------------------------------------------------------------------------")
    print("| Model Name     | Career | Race | Age | Nationality |")
    print("----------------------------------------------------------------------------------------")
    for i, model_id in enumerate(model_list):
