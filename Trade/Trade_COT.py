...
async def multi_evaluate(
    ...
    json_dump_path = './record/Tr_{}_{}_{}_{}-avg_deci_vector_w_COT.json'.format(bias_type, test_mode, game_name, model_name_temp)
    write_to_json(record_with_lang, json_dump_path)
    json_dump_path = './record/Tr_{}_{}_{}_{}-raw_responses_w_COT.json'.format(bias_type, test_mode, game_name, model_name_temp)
